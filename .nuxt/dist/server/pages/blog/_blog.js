...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/blog/_blog.vue?vue&type=template&id=8a6c687e&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"blog"},[_vm._ssrNode("<img"+(_vm._ssrAttr("src",_vm.blogPost.thumbnail))+" class=\"blog__featured-img\"> <h1 class=\"blog__title\">"+_vm._ssrEscape(_vm._s(_vm.blogPost.title))+"</h1>")])}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/blog/_blog.vue?vue&type=template&id=8a6c687e&
...
/* harmony default export */ var _blogvue_type_script_lang_js_ = ({
  ...
  async asyncData({
    ...
    if (payload) return {
      ...
      blogPost: await __webpack_require__(39)(`./${params.blog}.json`)
    };
  }
