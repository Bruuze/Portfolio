...
var add = __webpack_require__(3).default
module.exports.__inject__ = function (context) {
  add("3ae84f90", content, true, context)
};
...
"use strict";
const info = __webpack_require__(34);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_loading_vue_vue_type_style_index_0_id_1b2f19b6_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(7);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_loading_vue_vue_type_style_index_0_id_1b2f19b6_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_loading_vue_vue_type_style_index_0_id_1b2f19b6_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_loading_vue_vue_type_style_index_0_id_1b2f19b6_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_loading_vue_vue_type_style_index_0_id_1b2f19b6_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
 /* harmony default export */ __webpack_exports__["default"] = (_node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_loading_vue_vue_type_style_index_0_id_1b2f19b6_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0___default.a); 
...
exports = ___CSS_LOADER_API_IMPORT___(false);
// Module
exports.push([module.i, "div[data-v-1b2f19b6]{height:0;width:0;margin:0;padding:0}.loading-page[data-v-1b2f19b6]{position:fixed;top:0;left:0;width:100%;height:100%;background:#090915;text-align:center;font-size:30px;font-family:sans-serif;-webkit-animation-name:example-data-v-1b2f19b6;animation-name:example-data-v-1b2f19b6;-webkit-animation-duration:4s;animation-duration:4s;z-index:9999}.loading-page lottie-player[data-v-1b2f19b6]{padding:15%}@-webkit-keyframes example-data-v-1b2f19b6{75%{opacity:1}to{opacity:0}}@keyframes example-data-v-1b2f19b6{75%{opacity:1}to{opacity:0}}", ""]);
// Exports
module.exports = exports;
...
// Module
exports.push([module.i, "*,:after,:before{box-sizing:border-box;margin:0}#new-color{color:#f75ec8}html{font-family:\"Red Hat Text\",sans-serif;font-size:16px;word-spacing:1px;-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;-moz-osx-font-smoothing:grayscale;-webkit-font-smoothing:antialiased;box-sizing:border-box}h1,h2,h3,h4{font-family:\"Red Hat Display\",sans-serif}body{background-color:#090915;overflow-y:hidden;overflow-x:hidden}body #__layout{opacity:0}.nav{position:-webkit-sticky;position:sticky;top:0;width:100%;height:4rem;background-color:#090915;border-bottom:1px solid rgba(108,119,137,.24706);z-index:4}.responsive-padding{padding-left:1.5rem;padding-right:1.5rem}.nav__wrapper{height:inherit;justify-content:space-between;align-items:center;flex-direction:row;flex-wrap:nowrap;max-width:1600px;margin:0 auto}.nav__li{height:4rem;display:flex;align-items:center;padding-left:.75rem;padding-right:.75rem;white-space:nowrap}.nav__li--desktop-only{display:none}.nav__li--mobile-only{display:flex}ol.sematic-only,ul.sematic-only{list-style:none;padding-left:0}.nav__ul{margin-left:-.75rem;margin-right:-.75rem}.nav__ul,.nav__wrapper{display:flex}a{color:#c0cad8;text-decoration:none;transition:color .25s ease-in-out,opacity .25s ease-in-out;background-color:transparent;-webkit-font-smoothing:subpixel-antialiased}.nav__li a:hover{color:#fff;fill:#fff}a.nuxt-link-exact-active{color:#f75ec8;font-weight:500}a.nuxt-link-exact-active:hover{color:#f75ec8}@media (min-width:960px){.responsive-padding{padding-left:3rem;padding-right:3rem}.nav__li--desktop-only{display:flex}.nav__li--mobile-only{display:none}}", ""]);
// Exports
module.exports = exports;
...
exports = ___CSS_LOADER_API_IMPORT___(false);
// Module
exports.push([module.i, ".bodymovinanim{width:90%;max-width:50px;margin-top:18px;cursor:pointer}.bodymovinanim,.bounce-enter-active{-webkit-backface-visibility:hidden;backface-visibility:hidden;transform:translateZ(0)}.bounce-enter-active{-webkit-animation:bounce-in .5s;animation:bounce-in .5s}.bounce-leave-active{-webkit-animation:bounce-out .5s;animation:bounce-out .5s;-webkit-backface-visibility:hidden;backface-visibility:hidden;transform:translateZ(0)}@-webkit-keyframes bounce-in{0%{opacity:0;transform:translateY(200px)}to{opacity:1;transform:translateY(0)}}@keyframes bounce-in{0%{opacity:0;transform:translateY(200px)}to{opacity:1;transform:translateY(0)}}@-webkit-keyframes bounce-out{0%{opacity:1}to{opacity:0}}@keyframes bounce-out{0%{opacity:1}to{opacity:0}}", ""]);
// Exports
module.exports = exports;
...
module.exports = JSON.parse("{\"date\":\"2020-09-01T07:00:23.325Z\",\"title\":\"Another Great Blog\",\"thumbnail\":\"/img/clip-dump-2.png\",\"body\":\"**testiiiiiiiiiing**\"}");

/***/ }),
/* 31 */
/***/ (function(module) {

module.exports = JSON.parse("{\"date\":\"2020-09-01T07:13:31.273Z\",\"title\":\"tester\",\"thumbnail\":\"/img/artboard-1.png\",\"body\":\"gggg\"}");

/***/ }),
/* 32 */
/***/ (function(module) {

module.exports = JSON.parse("{\"date\":\"2020-08-31T06:54:25.111Z\",\"title\":\"Testing\",\"thumbnail\":\"/img/clip-dump.png\",\"body\":\"Testing 123\\n\\n![](/img/artboard-1.png)\\n\\n![](/img/mockup.png)\"}");
...
const _12bdecac = () => interopDefault(__webpack_require__.e(/* import() | pages/blog/index */ 2).then(__webpack_require__.bind(null, 47)));

const _04b959d9 = () => interopDefault(__webpack_require__.e(/* import() | pages/blog/_blog */ 1).then(__webpack_require__.bind(null, 48)));
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/loading.vue?vue&type=template&id=1b2f19b6&scoped=true&lang=html&
var loadingvue_type_template_id_1b2f19b6_scoped_true_lang_html_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return (_vm.loading)?_c('div',[_vm._ssrNode("<div class=\"loading-page\" data-v-1b2f19b6>","</div>",[_c('lottie-player',{attrs:{"src":"https://assets2.lottiefiles.com/packages/lf20_cbXcz6.json","background":"transparent","speed":"1","loop":"","autoplay":""}})],1)]):_vm._e()}
var loadingvue_type_template_id_1b2f19b6_scoped_true_lang_html_staticRenderFns = []


// CONCATENATED MODULE: ./components/loading.vue?vue&type=template&id=1b2f19b6&scoped=true&lang=html&
...
var loading_component = Object(componentNormalizer["a" /* default */])(
  ...
  loadingvue_type_template_id_1b2f19b6_scoped_true_lang_html_render,
  loadingvue_type_template_id_1b2f19b6_scoped_true_lang_html_staticRenderFns,
  false,
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./layouts/default.vue?vue&type=template&id=a7e2c614&
var defaultvue_type_template_id_a7e2c614_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_vm._ssrNode("<nav class=\"nav responsive-padding\">","</nav>",[_vm._ssrNode("<div class=\"nav__wrapper\">","</div>",[_vm._ssrNode("<ul class=\"nav__ul sematic-only\">","</ul>",[_vm._ssrNode("<li class=\"nav__li nav__li--desktop-only\">","</li>",[_c('nuxt-link',{attrs:{"to":"/"}},[_vm._v(" Home ")])],1),_vm._ssrNode(" "),_vm._ssrNode("<li class=\"nav__li nav__li--desktop-only\">","</li>",[_c('nuxt-link',{attrs:{"to":"/blog"}},[_vm._v(" Blog ")])],1)],2),_vm._ssrNode(" <ul class=\"nav__ul sematic-only\"><li class=\"nav__li nav__li--mobile-only\"><div class=\"bodymovinanim\"></div></li></ul>")],2)]),_vm._ssrNode(" "),_c('Nuxt')],2)}
var defaultvue_type_template_id_a7e2c614_staticRenderFns = []


// CONCATENATED MODULE: ./layouts/default.vue?vue&type=template&id=a7e2c614&
...
var default_component = Object(componentNormalizer["a" /* default */])(
  ...
  defaultvue_type_template_id_a7e2c614_render,
  defaultvue_type_template_id_a7e2c614_staticRenderFns,
  false,
